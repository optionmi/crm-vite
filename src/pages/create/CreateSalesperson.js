        ...
        <div className="publisher">
          ...
          <Card className="create-publisher-card shadow-sm" style={{'background': 'white', 'height': 'fit-content'}} >
            <Card.Body className='create-publisher-card-body'>
              <Form className='create-publisher-form' onSubmit={handleCreateSalesperson}>
                <div className="row">
                  ...
                  <div className='col-lg-6 col-md-6 col-12'>
                    <Form.Group className='create-publisher-form-group'>
                      ...
                      <Form.Control as="select" name='team'>
                        ...
                        <option value='SalesCoordinationTeam'>Sales Coordination Team</option>
                        <option value='OperationsTeam'>Operations Team</option>
                        <option value='ProductandTrainingTeam'>Product and Training Team</option>
                        <option value='DispatchandWarehouseTeam'>Dispatch and Warehouse Team</option>

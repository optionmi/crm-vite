    ...
    <div>
      ...
      <div className="publisher">
        <div className="header d-flex justify-content-between">
          <h4>Publishers</h4>
          <a className='btn btn-primary create-btn' href='/create/publisher'>Create Publisher</a>
        </div>
        {/* Publisher Header */}
        <div className="card">
                ...
                <div className="card" id="detail-card" key={publisher.id}>
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col-3">
                        <Link className='view-link' to={`/publisher/view/${publisher.id}`}><FontAwesomeIcon icon={faEye} id='eye-icon' /></Link>
                      </div>
                    </div>
                  </div>
                </div>

...
const leadsAPI = {
	getAllLeads: async (authToken) => {
		try {
			let response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/all`,
				{
					method: "GET",
					headers: {
	...
	getLeadById: async (authToken, leadId) => {
		try {
			let response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/${leadId}`,
				{
					method: "GET",
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	createLead: async (authToken, leadData) => {
		const response = await fetch(
			`${import.meta.env.VITE_APP_BASEURL}/api/leads/create`,
			{
				method: "POST",
				headers: {
					Authorization: `Bearer ${authToken}`,
	...
	addNote: async (authToken, leadId, note) => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/add-note/${leadId}`,
				{
					method: "POST",
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	addActivity: async (authToken, leadId, activity) => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/add-activity/${leadId}`,
				{
					method: "POST",
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	addFile: async (authToken, leadId, fileData) => {
		...
		try {
			const response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/add-file/${leadId}`,
				{
					method: "POST",
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	dailyPlanning: async (authToken, leadId, visitData) => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/add-visit/${leadId}`,
				{
					method: "POST",
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	getAllVisit: async (authToken) => {
		try {
			let response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/all/visit`,
				{
					method: "GET",
					headers: {
						Authorization: `Bearer ${authToken}`,
	...
	updateStage: async (authToken, leadId, updateData) => {
		try {
			const response = await fetch(
				`${import.meta.env.VITE_APP_BASEURL}/api/leads/update-stage/${leadId}`,
				{
					method: "POST",
					headers: {
						Authorization: `Bearer ${authToken}`,

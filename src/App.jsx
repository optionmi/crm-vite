...
// Importing Leaflet JS (optional, if you plan to use it directly)
				...
				if ("geolocation" in navigator) {
					...
					navigator.geolocation.getCurrentPosition(
						(position) => {
							...
							locationAPI.updateLocation(locationID, locationData, authToken);
						},
						(error) => {
	...
	return (
		<Routes>
			...
			<Route element={<PrivateRoute />}>
				...
				<Route exact path="/update-book/:bookID" element={<CreateBook />} />
				{/* Leads Routes */}
				...
				<Route exact path="/update-board/:boardID" element={<CreateBoards />} />
				{/* Subject */}
				...
				<Route exact path="/view/location/:id" element={<ViewLocation />} />
			</Route>
			{/* Quote */}
			...
			<Route exact path="/emails/view-email/:emailID" element={<ViewEmail />} />
		</Routes>
	);
}
